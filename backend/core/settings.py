...
CROSS_DOMAIN_COOKIES = env_bool('DJANGO_CROSS_DOMAIN_COOKIES', default=False)
SESSION_COOKIE_SAMESITE = 'None' if CROSS_DOMAIN_COOKIES else 'Lax'
CSRF_COOKIE_SAMESITE = 'None' if CROSS_DOMAIN_COOKIES else 'Lax'
