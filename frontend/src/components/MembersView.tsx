        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
          {members.map((m) => (
            <div
              ...
              className="card-hover-effect bg-white p-4 sm:p-5 rounded-3xl border border-slate-200/90 shadow-sm cursor-pointer group flex flex-col justify-between"
            >
              <div>
                <div className="flex items-start justify-between gap-2 mb-3">
                  ...
                  <div className="w-9 h-9 rounded-2xl bg-emerald-700 text-white font-black text-xs flex items-center justify-center shadow-md shrink-0">
                    {m.street_number}
                  </div>
                </div>
                ...
                <div className="pt-2.5 border-t border-slate-100 flex items-center justify-between gap-2 flex-wrap">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 p-2 rounded-xl bg-slate-50 hover:bg-amber-50 text-slate-500 hover:text-amber-700 border border-slate-200 hover:border-amber-300 text-[11px] font-black transition-colors disabled:opacity-50"
                    >
